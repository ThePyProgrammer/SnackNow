...
public class Node<T> {
    ...
    // Constructor to create model.algorithm.Node containing item of generic class T
    ...
    // Constructor to create model.algorithm.Node containing item of generic class T,
    // with child nodes defined in the neighbours model.algorithm.Node array
    ...
    // Copy constructor to copy the model.algorithm.Node object n
    public Node(Node<T> n){ this(n.item, n.neighbours); }

    // Accessor method returns item stored in model.algorithm.Node
    public T getItem() { return item;}

    // Mutator method sets the item to be stored in model.algorithm.Node
